...
"""autogenerated by genpy from musa/CounterActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CounterActionFeedback(genpy.Message):
  _md5sum = "8970b14594e4439a5064b6d3fc5e8d7e"
  _type = "musa/CounterActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','musa/CounterFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = musa.msg.CounterFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = musa.msg.CounterFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current,) = _get_struct_q().unpack(str[start:end])
      return self
