...
"""autogenerated by genpy from musa/CounterActionResult.msg. Do not edit."""
import codecs
import sys
...
class CounterActionResult(genpy.Message):
  _md5sum = "b867c7f71202f739742902b2c8f706ed"
  _type = "musa/CounterActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','musa/CounterResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = musa.msg.CounterResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = musa.msg.CounterResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.Limit_Reached,) = _get_struct_q().unpack(str[start:end])
      return self
