...
(cl:defmethod cl:initialize-instance :after ((m <CounterResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name musa-msg:<CounterResult> is deprecated: use musa-msg:CounterResult instead.")))

(cl:ensure-generic-function 'Limit_Reached-val :lambda-list '(m))
(cl:defmethod Limit_Reached-val ((m <CounterResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader musa-msg:Limit_Reached-val is deprecated.  Use musa-msg:Limit_Reached instead.")
  (Limit_Reached m))
